...
\end{equation}
where $\psi_n$ is the spatial plane of symmetry for the $n$-th harmonic. The first three $v_n$ coefficients ($v_1$\nomenclature{$v_1$}{Direct flow}, $v_2$\nomenclature{$v_2$}{Elliptic flow}, $v_3$\nomenclature{$v_3$}{Triangular flow}, \dots) are called the direct flow, the elliptic flow, and triangular flow coefficients for $v_1$, $v_2$, and $v_3$, respectively. They can be reformulated using the formula
\begin{equation}
