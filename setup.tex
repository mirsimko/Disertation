...
pseudorapidity\nomenclature{$\eta$}{Pseudorapidity}\ range of $|\eta| < 1$. 
...
TOF detector consists of 120 trays of Multi-gap Resistive Plate Chambers (MRPC)\nomenclature{MRPC}{Multi-gap Resistive Plate
...
\begin{figure}[!htb]
\begin{center}
 \includegraphics[width=0.8\textwidth]{img/forwardUpgrade}\\
\end{center}
...
The layout of this upgrade is shown in Figure~\ref{forward}\@. Two detector systems are being developed: the Forward Calorimeter System (FCS\nomenclature{FCS}{Forward Calorimeter System}) with an electromagnetic and hadronic calorimeters, and the Forward Tracking System (FTS\nomenclature{FTS}{Forward Tracking System})\@. To achieve the upgrade's goals, the design requirements for the FTS are the track-charge separation ability, 30$\,\%$ momentum resolution for tracks with 
$0.2< \pt <2\,$GeV/$c$, and more than $80\,\%$ efficiency at 100 track multiplicity per event\@. The FCS-electromagnetic calorimeter should achieve accuracy of $10\,\% / \sqrt{E}$ in p+p and p+ion collisions and $20\,\% / \sqrt{E}$ in ion+ion collisions and the FCS-hadron calorimeter $10\,\% + 50\,\% / \sqrt{E}$.
 ...
 The FTS consists of three radially oriented discs of silicon detectors, called the Forward Silicon Tracker (FST\nomenclature{FST}{Forward Silicon Tracker}), and three larger discs outside of the TPC, called Forward sTGC Tracker (FTT\nomenclature{FTT}{Forward sTGC Tracker})\@. The FST is made out of silicon micro-strip sensors similar to the IST (see Section~\ref{IstSection})\@. As the name suggests, the FTT is made of three discs small-strip Thin Gap Chambers (sTGC)~\cite{FTTproceedings}, similar to the ones already installed at the ATLAS detector~\cite{AtlasStgc}\@.
